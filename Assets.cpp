...
#include <sstream>
#include <fstream>
//#include "../opengl-training/SimpleEngineWithOpenGL/SimpleEngineWithOpenGL-032-3c/Log.h"
...
Texture Assets::loadTexture(RendererOGL& renderer, const string& filename, const string& name)
{
...
Texture Assets::loadTextureFromFile(RendererOGL& renderer, const string& filename)
{
    Texture texture;
    /*
...
Mesh Assets::loadMeshFromFile(const string& filename)
{
	...
	for (rapidjson::SizeType i = 0; i < vertsJson.Size(); i++)
	{
		...
		radius = fmax(radius, pos.length()*pos.length());
