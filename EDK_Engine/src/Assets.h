...
public:
    ...
    static Texture loadTexture(RendererOGL& renderer, const string& filename, const string& name);
...
private:
    ...
    static Texture loadTextureFromFile(RendererOGL& renderer, const string& filename);
